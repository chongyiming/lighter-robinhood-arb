...
zkLighter sends a snapshot plus diffs, which this class maintains as two
price->size dicts. Freshness is connection-based (any inbound ws frame touches alive_ts): a quiet
