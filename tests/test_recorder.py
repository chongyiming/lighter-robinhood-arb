...
from lighter_arb.recorder import HEADER, MinuteRecorder  # noqa: E402


def set_book(book, bid, ask):
    book.apply_lighter({"bids": [{"price": str(bid), "size": "10"}],
...
def test_minute_aggregation_and_rollover():
    ...
    # minute 1: base leg 10 bps rich, then 20 bps rich
    ...
    assert float(m2["base_bid"]) == 100.09
